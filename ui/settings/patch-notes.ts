...
const PATCH_NOTES: PatchNote[] = [
  {
    ...
    lines: {
      ko: [
        ...
        "펫이 오래전 이야기를 계속 되묻지 않습니다. 오래된 이야기는 먼저 꺼내지 않고, 사용자가 그 이야기를 다시 하면 기억해 냅니다.",
      ...
      en: [
        ...
        "The pet no longer keeps asking about old topics. It won't bring up older ones on its own, but it still remembers if you mention one again.",
      ...
      ja: [
        ...
        "ペットが昔の話を何度も聞き返さなくなりました。古い話題は自分から持ち出しませんが、もう一度話せばちゃんと覚えています。",
